  ...
  return (
    <nav className="container-nav">
        ...
        <div className="navbar navbar-actions">
            <Button class="button-nav profile-btn" onClick={() => navigate("/profile")} ><UserRound size={18}/></Button>
            <Button class="button-nav logout-btn" onClick={() => navigate("/login")}><LogOut size={18}/></Button>
        </div>
    </nav>
  );
}  
